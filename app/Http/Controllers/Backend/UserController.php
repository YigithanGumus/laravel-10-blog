...
class UserController extends Controller
{
    ...
    public function store(UserRequest $request)
    {
        ...
        return Redirect::to($this->returnUrl)->with('added', 'Ekleme başarılı!');
    }
    ...
    public function update(UserRequest $request, User $user)
    {
        ...
        return Redirect::to($this->returnUrl)->with('updated', 'Güncelleme başarılı!');
    }
    ...
    {
        $user->delete();
        return Redirect::to($this->returnUrl)->with('deleted', 'Silme başarılı!');
    }
    ...
    public function changePassword(User $user,UserRequest $request)
    {
        ...
        $user->fill($data);
        $user->save();
        return Redirect::to($this->returnUrl)->with('passord_changed', 'Şifre güncellemesi başarılı!');
